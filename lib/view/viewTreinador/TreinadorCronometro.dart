...
class TreinadorCronometro extends StatefulWidget {
  const TreinadorCronometro({super.key});

  @override
  State<TreinadorCronometro> createState() => _TreinadorCronometroState();
}

class _TreinadorCronometroState extends State<TreinadorCronometro> {
