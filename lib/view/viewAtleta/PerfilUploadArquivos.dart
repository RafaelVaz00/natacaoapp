                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          cpfImagemUrl != null
                              ? Image.network(cpfImagemUrl!, height: 250, width: 250)
                              : Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Icon(Icons.add_to_photos_outlined),
                          ...
                          comprovanteImagemUrl != null
                              ? Image.network(comprovanteImagemUrl!, height: 250, width: 250)
                              : Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Icon(Icons.add_to_photos_outlined),
                          ...
                          fotoImagemUrl != null
                              ? Image.network(fotoImagemUrl!, height: 250, width: 250)
                              : Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Icon(Icons.add_to_photos_outlined),
                          ...
                          regulamentoImagemUrl != null
                              ? Image.network(regulamentoImagemUrl!, height: 250, width: 250)
                              : Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Icon(Icons.add_to_photos_outlined),
